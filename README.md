...
### Decision surface
![Decision surface](fig_v2_surface.png)

### Sensitivity analysis (input influence)
![Sensitivity](fig_v2_senzitivnost.png)

### Fuzzy score vs. real problems
![Validation scatter](fig_v2_scatter.png)
...
*.csv                  dataset (versions, repositories, attribute-details, quality_versions)
*.fis                  saved fuzzy systems
*.png                  generated figures
*.docx                 report and representativeness analysis
```
